        ...
        var setBrushAttribute = (attr, val) => {
            ...
            switch (attr)
            {
                ...
                case "taper_tip":
                    ...
                    break;
                case "outline_size":
                    fabricCanvas.freeDrawingBrush.brush.setOutlineSize(val * 0.01); //0~20%
                    break;
                case "outline_contour":
                    fabricCanvas.freeDrawingBrush.brush.setOutlineContour(val * 0.01); //80~100%
                    break;
                case "outline_placement":
                    fabricCanvas.freeDrawingBrush.brush.setOutlinePlacement(val * 0.01); //0~100%
                    break;
                case "shape_scatter":
                ...
                case "dynamics_speedOpacity":
                    ...
                    break;
                case "dynamics_pressureSize":
                    fabricCanvas.freeDrawingBrush.brush.setDynamicPressureSize(val * 0.01); //-100%~100% stamp size relative to pressure
                    break;
                case "dynamics_pressureOpacity":
                    fabricCanvas.freeDrawingBrush.brush.setDynamicPressureOpacity(val * 0.01); //-100%~100% stamp opacity relative pressure
                    break;
